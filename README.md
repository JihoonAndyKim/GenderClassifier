...
- Run through all the cells in Gender_Classification_Challenge.ipynb
    
OR 
    
- Run the following command to train (Also will perform evaluation)
```
$ python gender_classifier_train.py
```
OR
        
- If only evaluation, then run the following command then to evaluate the model
```
